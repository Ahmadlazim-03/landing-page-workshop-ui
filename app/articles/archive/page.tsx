            ...
            <div className={`space-y-12 ${isLoaded ? "animate-fade-in" : "opacity-0"}`}>
              {sortedMonths.map((monthYear, i) => (
                <div key={monthYear} className="relative">
                  <div className="sticky top-21 z-10 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 rounded-lg shadow-md mb-6">
